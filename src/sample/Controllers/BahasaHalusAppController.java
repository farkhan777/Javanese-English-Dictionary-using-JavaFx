...
public class BahasaHalusAppController implements Initializable {
    ...
    void Kasar(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/sample/Views/BahasaKasarApp.fxml"));
        Node node = (Node) event.getSource();
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("select * from jawahalus");
