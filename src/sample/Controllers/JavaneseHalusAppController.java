...
public class JavaneseHalusAppController implements Initializable {
    ...
    void Kasar(MouseEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/sample/Views/JavaneseKasarApp.fxml"));
        Node node = (Node) event.getSource();
    ...
    @FXML
    void TetangKami(MouseEvent event) throws IOException {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ...
            ResultSet resultSet = connection.createStatement().executeQuery("select * from bahasahalus");
